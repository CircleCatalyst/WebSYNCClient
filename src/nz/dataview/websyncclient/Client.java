...
public class Client {
    ...
    * The WebSYNC version.
    */
   public static final String WEBSYNC_VERSION = "2.1.2";
   /**
    * The logger!
    */
   ...
   public Client() {
      try {
         ...
         systemConfigFilePath = System.getProperty(
                 ...
                 "C:/Program Files/WebSYNCClient/config/system.properties");
         initialiseConfig();
         initialiseLogger();
         initialiseProxy();
      } catch (IOException e) {
...
//      }
   ...
   public String getProxyPw() {
      ...
      String ret = Utilities.simpleDecrypt(appConfig.getProperty(
              "nz.dataview.websyncclient.proxy_pw"));
      if (ret == null) {
         ret = "";
      }
      if (logger.isTraceEnabled()) {
   ...
   public String getAuthenticationKey() {
      ...
      String ret = Utilities.simpleDecrypt(appConfig.getProperty(
              "nz.dataview.websyncclient.authentication_key"));
      if (ret == null) {
         ret = "";
      }
      if (logger.isTraceEnabled()) {
   ...
   public String getSmtpPassword() {
      ...
      String ret = Utilities.simpleDecrypt(appConfig.getProperty(
              "nz.dataview.websyncclient.smtp_password"));
      if (ret == null) {
         ret = "";
      }
      if (logger.isTraceEnabled()) {
